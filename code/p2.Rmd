...
A la vista de los resultados se puede decir que el clasificador no es bueno, con una precisión de clasificación de un 65%, es muy alta la tasa de error que se producce. Se observa que los errores de clasificación en su mayoría se producen en categorías contiguas, siendo 30 del total los errores de clasificación más allá de la categoría contigua, por ejemplo que un producto sea de calificación nutricional A y se clasifique como C, D o E. 
